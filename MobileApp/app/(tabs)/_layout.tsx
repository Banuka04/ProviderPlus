...
function AnimatedTabBar({ state, descriptors, navigation }: any) {
  ...
  const isDarkbgPage = pathname.includes('UserLogin') || pathname.includes('Orders') || pathname.includes('Alerts') || pathname.includes('CustomerProfile');
          ...
          {visibleRoutes.map((route: any) => {
            ...
            const onPress = () => {
              ...
              if (!focused && !event.defaultPrevented) {
                if (route.name === 'UserLogin' && role === 'user') {
...
export default function TabLayout() {
  ...
  return (
      ...
      >
        ...
        <Tabs.Screen name="CustomerProfile" options={{ title: 'ACCOUNT', href: null }} />
      </Tabs>
  );
}
